...
import { Transaction, TransactionStatus, PaymentMethod } from '../payments/entities/transaction.entity';
...
describe('EmailService', () => {
  ...
  describe('sendContactEmail', () => {
    it('should send contact form email to admin with replyTo', async () => {
      await service.sendContactEmail('Visitor', 'visitor@test.com', 'Question', 'Hello there');
