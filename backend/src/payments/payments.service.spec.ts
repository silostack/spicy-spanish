...
describe("PaymentsService", () => {
  ...
  describe("findPackageById", () => {
    ...
    it("should throw NotFoundException when not found", async () => {
      ...
      await expect(service.findPackageById("bad-id")).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe("updatePackage", () => {
    it("should update package and Stripe product", async () => {
      ...
      await service.updatePackage("pkg-1", {
        name: "Updated Pack",
      });
  ...
  describe("findTransactionById", () => {
    ...
    it("should throw NotFoundException when not found", async () => {
      ...
      await expect(service.findTransactionById("bad")).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe("createStripeCheckoutSession", () => {
    ...
    it("should throw NotFoundException when student not found", async () => {
      userRepo.findOne.mockResolvedValue(null);
      await expect(service.createStripeCheckoutSession(dto)).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it("should throw BadRequestException when package is inactive", async () => {
      packageRepo.findOne.mockResolvedValue(
        createMockPackage({ isActive: false }),
      );
      await expect(service.createStripeCheckoutSession(dto)).rejects.toThrow(
        BadRequestException,
      );
  ...
  describe("completeManualPayment", () => {
    ...
    it("should throw BadRequestException when transaction is not pending", async () => {
      ...
      await expect(service.completeManualPayment("txn-1")).rejects.toThrow(
        BadRequestException,
      );
    });
    ...
    it("should throw NotFoundException when transaction not found", async () => {
      transactionRepo.findOne.mockResolvedValue(null);
      await expect(service.completeManualPayment("bad")).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe("getStudentBalance", () => {
    ...
    it("should throw NotFoundException when student not found", async () => {
      userRepo.findOne.mockResolvedValue(null);
      await expect(service.getStudentBalance("bad")).rejects.toThrow(
        NotFoundException,
      );
    });
  });
